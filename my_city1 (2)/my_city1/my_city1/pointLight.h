...
public:
    ...
    PointLight(float dirX, float dirY, float dirZ, float posX, float posY, float posZ, float ambR, float ambG, float ambB, float diffR, float diffG, float diffB, float specR, float specG, float specB, float constant, float linear, float quadratic, int num) {
    ...
    void setUpPointLight(Shader& lightingShader)
    {
        ...
        if (lightNumber == 1) {
            ...
            lightingShader.setVec3("pointLights[0].direction", direction);
            ...
            /*lightingShader.setVec3("directionalLight[0].direction", position);
            ...
            lightingShader.setFloat("directionalLight[0].k_c", k_c);
            lightingShader.setFloat("directionalLight[0].k_l", k_l);
            lightingShader.setFloat("directionalLight[0].k_q", k_q);*/
        }
        ...
        else if (lightNumber == 2)
        {
            ...
            lightingShader.setVec3("pointLights[1].direction", direction);
        ...
        else if (lightNumber == 3)
        {
            ...
            lightingShader.setVec3("pointLights[2].direction", direction);
